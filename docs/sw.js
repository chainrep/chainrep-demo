...
const cacheName = `0.1.0:52a308f0`; // Change value to force update
const filesToCache = `["./","build/bundle.js","build/bundle.css","favicon.png","icofont/fonts/icofont.woff","icofont/fonts/icofont.woff2","icofont/icofont.min.css","img/discord.svg","img/github.svg","img/icon.svg","index.html","style/main.css"]`; // Generated filenames as string array
